...
TRADE_LOG_CSV = os.path.join(HERE, "equity_sim_trades_ultimate_size100_2020_2026.csv")
EQUITY_CSV = os.path.join(HERE, "equity_sim_curve_ultimate_size100_2020_2026.csv")
OPEN_POSITIONS_CSV = os.path.join(HERE, "open_positions_ultimate_size100_2020_2026.csv")
